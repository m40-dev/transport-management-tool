![](./lib/ui/img/icons/icon2.png =80x80)
...
* Download the Tranport Manager package from Downloads page (https://bitbucket.org/emergencycode/transport-manager/downloads/)
...
* Cystomizable display columns in tree view (name and descripton placeholders are always there, but additional fields can be added to display)
