...
class Transport_Manager(QMainWindow):
    ...
    def __init__(
        ...
        self.ui.actionSaveFile.triggered.connect(self.XMLTemplateEditor.saveXMLTemplate)
        self.ui.actionSave_As.triggered.connect(self.XMLTemplateEditor.saveXMLTemplateAs)
        ...
        self.ui.actionNew_Transport_Template.triggered.connect(self.XMLTemplateEditor.newTransportTemplate)
    ...
    def connect_database(self, connection_name):
        ...
        if self.db is not None:
            ...
            self.XMLTemplateEditor.reload_ui()
    ...
    def closeApplicationEvent(self, event, force=False):
        self.settings.setValue("geometry", self.saveGeometry())
        self.settings.setValue("windowState", self.saveState())
        self.settings.setValue("relation_presets", self.XMLTemplateEditor.relation_presets)
