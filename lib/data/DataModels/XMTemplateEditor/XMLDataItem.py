...
class XMLDataItem(QObject):
    ...
    def loadDatabaseObject(self):
        ...
        if self._xml_data is not None and self._xml_data.xml_object_class == "Transport_Object":
            ...
            selected_relations, skipped_relations = self.select_referenced_relations(source=self.object_relations, target=db_relations, ignore_initial_state=True, match_parent_column=False)
