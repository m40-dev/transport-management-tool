...
class TE_TransportTask_TreeWidgetItem(TemplateEditorTreeWidgetItem):
    def __init__(self, XMLTemplateEditor, application, object_data, xml_object=None, source_widget_item=None):
        super(TE_TransportTask_TreeWidgetItem, self).__init__(XMLTemplateEditor=XMLTemplateEditor, application=application, object_data=object_data, xml_object=xml_object, source_widget_item=source_widget_item)
...
class TE_ObjectTransportTask_TreeWidgetItem(TE_TransportTask_TreeWidgetItem):
    def __init__(self, XMLTemplateEditor, application, object_data, xml_object=None, source_widget_item=None):
        super(TE_ObjectTransportTask_TreeWidgetItem, self).__init__(XMLTemplateEditor=XMLTemplateEditor, application=application, object_data=object_data, xml_object=xml_object, source_widget_item=source_widget_item)


class TE_SQLTransportTask_TreeWidgetItem(TE_TransportTask_TreeWidgetItem):
    def __init__(self, XMLTemplateEditor, application, object_data, xml_object=None, source_widget_item=None):
        super(TE_SQLTransportTask_TreeWidgetItem, self).__init__(XMLTemplateEditor=XMLTemplateEditor, application=application, object_data=object_data, xml_object=xml_object, source_widget_item=source_widget_item)
    ...
    def add_script(self, script_type):
        if isinstance(self.xml_object, sql_script_transport_task):
            ...
            script_widget = TE_SQLScriptContainer_TreeWidgetItem(self.XMLTemplateEditor, self.application, xml_data, xml_data)
