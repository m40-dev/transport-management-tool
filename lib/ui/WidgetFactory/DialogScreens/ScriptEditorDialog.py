...
class ScriptEditorDialog(CustomDialogWindow):

    def __init__(self, application, script_content):
        super(ScriptEditorDialog, self).__init__(application=application)
        ...
        self.form_layout.addWidget(self.editor, 0, 0, 1, 2)
