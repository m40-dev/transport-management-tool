...
from PyQt6.QtWidgets import QWidget, QToolButton, QLabel, QHBoxLayout, QMainWindow, QDialog, QFrame
...
class CustomBase(QFrame):
    def __init__(self, parent=None, use_mica='false', theme='auto', color="F0F0F0A0"):
...
class CustomWindow(CustomBase):
    ...
    def __init__(self, parent=None, use_mica='false', theme='auto', color="F2F2F299"):
        ...
        """
        self.parent = parent
        CustomBase.__init__(self, parent=parent, use_mica=use_mica, theme=theme, color=color)
    ...
    def nativeEvent(self, event_type, message):
        ...
        if msg.message == win32con.WM_NCHITTEST:
            ...
            if self.is_win11 and self.title_bar and self.title_bar.childAt(
